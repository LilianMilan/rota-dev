    ...
    <div style={{
      ...
      >
        ...
        {locked ? (
          ...
          <span style={{
            fontSize: "12px", color: "#444", transition: "transform 0.2s",
  ...
  return (
    <div style={{
      ...
      <p style={{ fontSize: "13px", color: "#888", marginBottom: "1.5rem", lineHeight: 1.6 }}>
        No plano Pro você acessa todos os {`>`} 7 dias da trilha, agente IA,
        progresso salvo na nuvem e muito mais.
      </p>
      <button
  ...
  return (
    <div>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
        {visibleDays.map(day => (
          <DayCard key={day.day} day={day} locked={false} checkedTasks={checkedTasks} onToggle={toggleTask} />
        ))}
        {lockedDays.map(day => (
          <DayCard key={day.day} day={day} locked={true} checkedTasks={[]} onToggle={() => {}} />
        ))}
      </div>
