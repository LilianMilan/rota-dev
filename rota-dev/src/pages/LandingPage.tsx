      ...
      {!isSignedIn && (
        <>
          ...
          <section style={{ padding: "60px 2rem", maxWidth: "700px", margin: "0 auto" }}>
            ...
            <div className="landing-pricing-grid">
              <div style={{ background: "#111", border: "1px solid #1e1e1e", borderRadius: "20px", padding: "2rem" }}>
                ...
                <button onClick={() => navigate("/login")} style={{ width: "100%", padding: "10px", background: "transparent", border: "1px solid #2a2a2a", borderRadius: "10px", color: "#888", fontSize: "13px", cursor: "pointer", marginBottom: "1.5rem" }}>
                  Começar grátis
                </button>
              ...
              <div style={{ background: "linear-gradient(135deg, #111 0%, #1a0e00 100%)", border: "1px solid rgba(249,115,22,0.3)", borderRadius: "20px", padding: "2rem", position: "relative", overflow: "hidden" }}>
                ...
                <button onClick={() => navigate("/login")} style={{ width: "100%", padding: "10px", background: "#f97316", border: "none", borderRadius: "10px", color: "#fff", fontSize: "13px", fontWeight: 600, cursor: "pointer", marginBottom: "1.5rem" }}
                  onMouseEnter={e => (e.currentTarget.style.opacity = "0.85")}
                  onMouseLeave={e => (e.currentTarget.style.opacity = "1")}
                >
                  Assinar Pro
          ...
          <section style={{ padding: "80px 2rem", textAlign: "center" }}>
            <h2 style={{ fontSize: "28px", fontWeight: 700, marginBottom: "12px" }}>Pronto pra começar?</h2>
